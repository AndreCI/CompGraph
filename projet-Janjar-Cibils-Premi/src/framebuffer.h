...
class FrameBuffer {
    ...
    private:
        ...
        GLuint height_texture_id_;
        GLuint river_texture_id_;
    ...
    public:
        ...
        int Init(int image_width, int image_height, bool use_interpolation = false) {
            ...
            {
                glGenTextures(1, &height_texture_id_);
                ...
                glGenTextures(1, &river_texture_id_);
                glBindTexture(GL_TEXTURE_2D, river_texture_id_);
                glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_WRAP_S, GL_CLAMP_TO_EDGE);
                glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_WRAP_T, GL_CLAMP_TO_EDGE);
            ...
            // tie it all together
            {
                ...
                glFramebufferTexture2D(GL_FRAMEBUFFER,
                                       ...
                                       GL_TEXTURE_2D, height_texture_id_,
                                       0 /*level*/);
                glFramebufferTexture2D(GL_FRAMEBUFFER,
                                       GL_COLOR_ATTACHMENT1 /*location = 1*/,
                                       GL_TEXTURE_2D, river_texture_id_,
                                       0 /*level*/);
            ...
            return height_texture_id_;
        }

        int getRiverTextureId(){
            return river_texture_id_;
        }

        void Cleanup() {
            glDeleteTextures(1, &height_texture_id_);
            glDeleteTextures(1, &river_texture_id_);
